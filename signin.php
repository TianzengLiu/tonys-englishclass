...
<div class="logo-top">
  ...
  <button type="submit" id="submit" class="btn btn-primary">Sign In</button><br><br>
  
  <hr>
     <h5>New user?</h5>
  
   <a href="register.php" class="btn btn-primary" role="button">Create An Account</a>
        <small id="emailHelp" class="form-text text-muted"><i>By creating an account, you accept the terms of our</i> Privacy Policy.</small>
